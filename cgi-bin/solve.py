...
def solve_metis(filename, num_parts):
	os.system("gpmetis -tpwgts=%s.targetweights %s.graph %d" % \
...
def solve(input_filename, tmp_filename):
	info = process_file(input_filename)
	part_sizes = info[1]
